            ...
            <div class="col-lg-8  mb-5 mb-lg-0">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="fontend/images/post/post-10.jpg" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="fontend/images/post/post-3.jpg" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                ...
                <article class="card mb-4">
                    <div class="card-body">
                        ...
                        <ul class="card-meta list-inline">
                            <li class="list-inline-item">
                                <a href="author-single.html" class="card-meta-author">
                                    <img src="fontend/images/kate-stone.jpg" alt="Kate Stone">
