        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="content pl-lg-3 pl-0">
                    <h2 id="what-is-the-main-mission-of-mine-and-what-i-wanna-do">What is the main mission of mine
                        and what i wanna do?</h2>
...
<section class="section wave">
    <img src="fontend/images/backgrounds/wave-bg.svg" class="wave-bg">
    <div class="container">
        <div class="row justify-content-around align-items-center">
            ...
            <div class="col-lg-4 col-md-6 text-center">
                ...
                <p class="mx-lg-3">Lorem ipsum dolor sit amet, sadipscing elitr, sed diam nonumy tempor invidunt
                    labore magna aliquyam</p>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-5 col-md-6 mb-4 mb-md-0 order-1 order-md-2">
                <div class="image-wrapper">
                    <img class="img-fluid w-100" src="images/about-us-2.jpg">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
                <div class="video-wrapper">
                    ...
                    <a class="play-btn video-btn" data-toggle="modal"
                        data-src="https://www.youtube.com/embed/dyZcRRWiuuw" data-target="#myModal"
